...
# Initialize wandb
wandb.init(project="omnidir_nav_pretraining", id=f"got_vit_{time}")
...
head = 4
vit_model = GoTPolicy(
    nb_actions=num_actions, nb_pstate=goal_size, block=2, head=4, img_width=256, img_height=64, num_channels=2
).to(device)
